...
export function WardrobeLanding() {
    ...
    <>
      <section className="bg-wine text-chiffon">
        <div className="mx-auto max-w-editorial px-6 py-20 text-center md:py-28">
          ...
          <h1 className="mt-6 font-display text-5xl font-normal text-chiffon md:text-7xl">Your closet, organised.</h1>
          <p className="mx-auto mt-6 max-w-xl text-base font-light leading-relaxed text-chiffon/80">
            Build a beautiful gallery of everything you own — upload a photo or paste a link, sort by category,
            and shop your own wardrobe before you buy something new.
          </p>
        </div>
      </section>
